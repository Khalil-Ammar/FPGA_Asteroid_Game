...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net miso_1 [get_bd_ports miso] [get_bd_pins mySPIRxTx_0/miso]
  ...
  connect_bd_net -net myPrescaler_0_out [get_bd_ports mclk] [get_bd_pins myI2STx_0/mclk] [get_bd_pins myPrescaler_0/prescale]
  connect_bd_net -net myPrescaler_1_prescale [get_bd_ports heartbeat] [get_bd_pins myPrescaler_1/prescale]
