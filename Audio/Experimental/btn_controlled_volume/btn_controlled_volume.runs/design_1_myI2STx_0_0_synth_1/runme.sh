...
HD_PWD='C:/Users/khali/ENSC_452/Project_modules/Audio/New_folder/SPIRxTxDemo/SPIRxTxDemo.runs/design_1_myI2STx_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_myI2STx_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_myI2STx_0_0.tcl
